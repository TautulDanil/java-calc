...
### 1) Ar trebui pe viitor sa folosim fisiere multiple pentru a face programe?.La alte materii de obicei faceam un fisier main.*,functii.* si un header.*,precum in java din cate stiu eu nu putem folosi header dau skip la pasul acesta.

### 2) Este vreo greseala,daca folosim toate functiile intr-un singur fisier?
